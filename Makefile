...
priv/graphql_parser.so: src/graphqlparser_nif.c
	cc -undefined dynamic_lookup -dynamiclib -I$(ERL_INCLUDE_PATH) -I/usr/local/include/graphqlparser/ -L/usr/local/lib -lgraphqlparser src/graphqlparser_nif.c -o graphql_parser.so
